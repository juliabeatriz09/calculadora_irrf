function irrf(){
   ...
   //  inicio calculo 
     if (salario<=2259.20){
        ...
        document.getElementById('valor').innerText =   result.toFixed(2);

     }else if( salario<=3751.65){
        deducao= (381.44 * num_depe) / num_depe;
        base = salario -  deducao;
        ...
        deducao= (662.77 * num_depe) / num_depe;
        base = salario - deducao;
        ...
        deducao = (896.00 * num_depe) / num_depe;
        base = salario - deducao;
